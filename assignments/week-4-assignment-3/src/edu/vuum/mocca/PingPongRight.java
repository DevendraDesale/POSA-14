...
public class PingPongRight {
	...
	public static class PlayPingPongThread extends Thread {
		 ...
		 */
		SimpleSemaphore[]pingpongs = new SimpleSemaphore[2];
		...
		public PlayPingPongThread(String stringToPrint,
			...
			// TODO - You fill in here.
			 this.printString = stringToPrint;
	            this.pingpongs[FIRST_SEMA] = semaphoreOne;
	            this.pingpongs[SECOND_SEMA] = semaphoreTwo;
		...
		private void acquire() {
			pingpongs[SECOND_SEMA].acquireUninterruptibly();
		}
	...
	public static void process(String startString, String pingString,
		...
		SimpleSemaphore pingSema = new SimpleSemaphore(0, false);
